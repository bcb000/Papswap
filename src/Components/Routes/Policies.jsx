...
function Policies() {
  ...
  return (
    <div className='m-2 m-md-5 p-2 p-md-3'>
      ...
      <ul>
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Papswap.</li>
        ...
        <li><strong>Website</strong> refers to Papswap, accessible from <a href="http://www.papswap.in" target="_blank">papswap.in</a></li>
